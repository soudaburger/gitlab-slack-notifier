...
COMMIT_MESSAGE = "<{0}|{1}/{2}> commit to {3} with job <{4}|{5}> by <{6}/{7}|{7}>".format(CI_PROJECT_URL, CI_PROJECT_NAMESPACE, CI_ENVIRONMENT_NAME, CI_COMMIT_BRANCH, CI_JOB_URL, CI_JOB_ID, CI_SERVER_URL, GITLAB_USER_LOGIN)
